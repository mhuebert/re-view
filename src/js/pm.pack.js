...
exports.Node = __webpack_require__(16).Node;var assign;
assign = __webpack_require__(17), exports.ResolvedPos = assign.ResolvedPos, exports.NodeRange = assign.NodeRange;
exports.Fragment = __webpack_require__(3).Fragment;var assign$1;
assign$1 = __webpack_require__(11), exports.Slice = assign$1.Slice, exports.ReplaceError = assign$1.ReplaceError;
exports.Mark = __webpack_require__(4).Mark;var assign$2;
assign$2 = __webpack_require__(36), exports.Schema = assign$2.Schema, exports.NodeType = assign$2.NodeType, exports.MarkType = assign$2.MarkType;var assign$3;
assign$3 = __webpack_require__(15), exports.ContentMatch = assign$3.ContentMatch;

exports.DOMParser = __webpack_require__(35).DOMParser;
exports.DOMSerializer = __webpack_require__(37).DOMSerializer;
...
;var assign;
assign = __webpack_require__(18), exports.Selection = assign.Selection, exports.SelectionRange = assign.SelectionRange, exports.TextSelection = assign.TextSelection, exports.NodeSelection = assign.NodeSelection, exports.AllSelection = assign.AllSelection;

exports.Transaction = __webpack_require__(19).Transaction;

exports.EditorState = __webpack_require__(39).EditorState;var assign$1;
assign$1 = __webpack_require__(38), exports.Plugin = assign$1.Plugin, exports.PluginKey = assign$1.PluginKey;
...
;var assign;
assign = __webpack_require__(9), exports.Transform = assign.Transform, exports.TransformError = assign.TransformError;var assign$1;
assign$1 = __webpack_require__(12), exports.Step = assign$1.Step, exports.StepResult = assign$1.StepResult;var assign$2;
assign$2 = __webpack_require__(21), exports.joinPoint = assign$2.joinPoint, exports.canJoin = assign$2.canJoin, exports.canSplit = assign$2.canSplit, exports.insertPoint = assign$2.insertPoint, exports.liftTarget = assign$2.liftTarget, exports.findWrapping = assign$2.findWrapping;var assign$3;
assign$3 = __webpack_require__(7), exports.StepMap = assign$3.StepMap, exports.MapResult = assign$3.MapResult, exports.Mapping = assign$3.Mapping;var assign$4;
assign$4 = __webpack_require__(20), exports.AddMarkStep = assign$4.AddMarkStep, exports.RemoveMarkStep = assign$4.RemoveMarkStep;var assign$5;
...
__webpack_require__(40);var assign$6;
assign$6 = __webpack_require__(41), exports.replaceStep = assign$6.replaceStep;
...
function scanFor(node, off, targetNode, targetOff, dir) {
  for (;;) {
    ...
    if (off == (dir < 0 ? 0 : nodeSize(node))) {
      var parent = node.parentNode;
      if (parent.nodeType != 1 || hasBlockDesc(node) || atomElements.test(node.nodeName)) {
        return false;
      }
...
prototypeAccessors$1.openLeft.get = function () {
  warnAboutOpen();return this.openStart;
};
prototypeAccessors$1.openRight.get = function () {
  warnAboutOpen();return this.openEnd;
};
...
WidgetType.prototype.eq = function (other) {
  return this == other || other instanceof WidgetType && (this.widget == other.widget || this.spec.key) && compareObjs(this.spec, other.spec);
};
...
prototypeAccessors.spec.get = function () {
...
function joinBackward(state, dispatch, view) {
  ...
  return !before.type.spec.isolating && deleteBarrier(state, cut, dispatch) || selectNextNode(state, cut, -1, dispatch);
}
...
function deleteBarrier(state, cut, dispatch) {
  ...
  if ($cut.parent.canReplace($cut.index(), $cut.index() + 1) && (conn = (match = before.contentMatchAt(before.childCount)).findWrappingFor(after)) && match.matchType((conn[0] || after).type, (conn[0] || after).attrs).validEnd()) {
    if (dispatch) {
...
var RopeSequence = __webpack_require__(49);
var ref = __webpack_require__(2);
var Mapping = ref.Mapping;
var ref$1 = __webpack_require__(1);
...
function applyTransaction(history, selection, tr, options) {
  ...
  if (tr.steps.length == 0) {
    ...
    var newGroup = history.prevTime < (tr.time || 0) - options.newGroupDelay || !appended && !isAdjacentToLastStep(tr, history.prevMap, history.done);
    return new HistoryState(history.done.addTransform(tr, newGroup ? selection.getBookmark() : null, options), Branch.empty, tr.mapping.maps[tr.steps.length - 1], tr.time);
...
;var assign;
assign = __webpack_require__(10), exports.InputRule = assign.InputRule, exports.inputRules = assign.inputRules, exports.undoInputRule = assign.undoInputRule;var assign$1;
assign$1 = __webpack_require__(32), exports.emDash = assign$1.emDash, exports.ellipsis = assign$1.ellipsis, exports.openDoubleQuote = assign$1.openDoubleQuote, exports.closeDoubleQuote = assign$1.closeDoubleQuote, exports.openSingleQuote = assign$1.openSingleQuote, exports.closeSingleQuote = assign$1.closeSingleQuote, exports.smartQuotes = assign$1.smartQuotes, exports.allInputRules = assign$1.allInputRules;var assign$2;
...
var keyName = __webpack_require__(50);
var ref = __webpack_require__(1);
var Plugin = ref.Plugin;
...
var tableRow = {
  attrs: { columns: { default: 1 } },
  parseDOM: [{ tag: "tr", getAttrs: function getAttrs(dom) {
...
var ref$2 = __webpack_require__(44);
...
var OrderedMap = __webpack_require__(31);
...
function parseFromClipboard(view, text, html, plainText, $context) {
  ...
  var contextNode = dom.querySelector("[data-pm-context]"),
      context = contextNode && contextNode.getAttribute("data-pm-context");
  if (context == "none") {
...
var DOMObserver = function DOMObserver(view) {
  ...
  if (useCharData) {
    this.onCharData = function (e) {
      return this$1.registerMutation({ target: e.target, type: "characterData" });
    };
  }
};
  ...
  view.someProp("handleDOMEvents", function (currentHandlers) {
    for (var type in currentHandlers) {
      if (!view.extraHandlers[type] && !handlers.hasOwnProperty(type)) {
        ...
        view.dom.addEventListener(type, function (event) {
...
handlers.copy = editHandlers.cut = function (view, e) {
  ...
  var slice = sel.content(),
      dom = serializeForClipboard(view, slice);
  if (data) {
    e.preventDefault();
    data.clearData();
...
editHandlers.drop = function (view, e) {
  ...
  var slice = dragging && dragging.slice || parseFromClipboard(view, e.dataTransfer.getData("text/plain"), e.dataTransfer.getData("text/html"), false, $mouse);
  if (!slice) {
    return;
  }
...
var CursorWrapperDesc = function (WidgetViewDesc) {
  ...
  CursorWrapperDesc.prototype.ignoreMutation = function () {
    return false;
  };
...
var NodeViewDesc = function (ViewDesc) {
  ...
  NodeViewDesc.prototype.parseRule = function () {
    ...
    if (this.contentDOM && !this.contentLost) {
      ...
      return { node: this.node.type.name, attrs: this.node.attrs, getContent: function getContent() {
...
function customNodeViews(view) {
  if (cachedCustomFor == view._props) {
...
var _prosemirrorView = __webpack_require__(30);
...
Object.defineProperty(exports, "Selection", {
  enumerable: true,
  get: function get() {
    return _prosemirrorState.Selection;
  }
});
Object.defineProperty(exports, "SelectionRange", {
  enumerable: true,
  get: function get() {
    return _prosemirrorState.SelectionRange;
  }
});
...
Object.defineProperty(exports, "AllSelection", {
  enumerable: true,
  get: function get() {
    return _prosemirrorState.AllSelection;
  }
});
Object.defineProperty(exports, "Transaction", {
  enumerable: true,
  get: function get() {
    return _prosemirrorState.Transaction;
  }
});
...
var _prosemirrorKeymap = __webpack_require__(27);

Object.defineProperty(exports, "keymap", {
  enumerable: true,
  get: function get() {
    return _prosemirrorKeymap.keymap;
  }
});

var _prosemirrorCommands = __webpack_require__(24);

Object.defineProperty(exports, "commands", {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_prosemirrorCommands).default;
  }
});

var _prosemirrorHistory = __webpack_require__(25);

Object.defineProperty(exports, "history", {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_prosemirrorHistory).default;
  }
});

var _prosemirrorTransform = __webpack_require__(2);
...
var _prosemirrorSchemaList = __webpack_require__(28);
...
var _prosemirrorInputrules = __webpack_require__(26);

Object.defineProperty(exports, "InputRule", {
  enumerable: true,
  get: function get() {
    return _prosemirrorInputrules.InputRule;
  }
});
...
Object.defineProperty(exports, "inputRules", {
  enumerable: true,
  get: function get() {
    return _prosemirrorInputrules.inputRules;
  }
});
Object.defineProperty(exports, "undoInputRule", {
  enumerable: true,
  get: function get() {
    return _prosemirrorInputrules.undoInputRule;
  }
});
Object.defineProperty(exports, "allInputRules", {
  enumerable: true,
  get: function get() {
    return _prosemirrorInputrules.allInputRules;
  }
});
...
Object.defineProperty(exports, "Schema", {
  enumerable: true,
  get: function get() {
    return _prosemirrorModel.Schema;
  }
});
Object.defineProperty(exports, "Node", {
  enumerable: true,
  get: function get() {
    return _prosemirrorModel.Node;
  }
});
Object.defineProperty(exports, "Mark", {
  enumerable: true,
  get: function get() {
    return _prosemirrorModel.Mark;
  }
});
Object.defineProperty(exports, "ResolvedPos", {
  enumerable: true,
  get: function get() {
    return _prosemirrorModel.ResolvedPos;
  }
});
Object.defineProperty(exports, "NodeRange", {
  enumerable: true,
  get: function get() {
    return _prosemirrorModel.NodeRange;
  }
});
Object.defineProperty(exports, "Fragment", {
  enumerable: true,
  get: function get() {
    return _prosemirrorModel.Fragment;
  }
});
Object.defineProperty(exports, "Slice", {
  enumerable: true,
  get: function get() {
    return _prosemirrorModel.Slice;
  }
});
Object.defineProperty(exports, "MarkType", {
  enumerable: true,
  get: function get() {
    return _prosemirrorModel.MarkType;
  }
});
Object.defineProperty(exports, "NodeType", {
  enumerable: true,
  get: function get() {
    return _prosemirrorModel.NodeType;
  }
});

var _prosemirrorSchemaTable = __webpack_require__(29);

Object.defineProperty(exports, "table", {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_prosemirrorSchemaTable).default;
  }
});
Object.defineProperty(exports, "model", {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_prosemirrorModel).default;
  }
});
