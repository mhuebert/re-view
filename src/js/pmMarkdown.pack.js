...
exports.schema = __webpack_require__(0).schema
;var assign;
((assign = __webpack_require__(3), exports.defaultMarkdownParser = assign.defaultMarkdownParser, exports.MarkdownParser = assign.MarkdownParser, assign))
;var assign$1;
((assign$1 = __webpack_require__(4), exports.MarkdownSerializer = assign$1.MarkdownSerializer, exports.defaultMarkdownSerializer = assign$1.defaultMarkdownSerializer, exports.MarkdownSerializerState = assign$1.MarkdownSerializerState, assign$1))
...
var defaultMarkdownParser = new MarkdownParser(schema, markdownit("commonmark", {html: false}), {
  ...
  fence: {block: "code_block", attrs: function (tok) { return ({params: tok.info || ""}); }},
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_prosemirror_markdown__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_prosemirror_markdown___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_prosemirror_markdown__);
/* harmony reexport (binding) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0_prosemirror_markdown__, "schema")) __webpack_require__.d(__webpack_exports__, "schema", function() { return __WEBPACK_IMPORTED_MODULE_0_prosemirror_markdown__["schema"]; });
/* harmony reexport (binding) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0_prosemirror_markdown__, "defaultMarkdownParser")) __webpack_require__.d(__webpack_exports__, "defaultMarkdownParser", function() { return __WEBPACK_IMPORTED_MODULE_0_prosemirror_markdown__["defaultMarkdownParser"]; });
/* harmony reexport (binding) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0_prosemirror_markdown__, "defaultMarkdownSerializer")) __webpack_require__.d(__webpack_exports__, "defaultMarkdownSerializer", function() { return __WEBPACK_IMPORTED_MODULE_0_prosemirror_markdown__["defaultMarkdownSerializer"]; });
