...
(def github-icon
  [:svg {:fill "currentColor" :view-box "0 0 16 16", :xmlns "http://www.w3.org/2000/svg", :fill-rule "evenodd", :clip-rule "evenodd", :stroke-linejoin "round", :stroke-miterlimit "1.414"}
